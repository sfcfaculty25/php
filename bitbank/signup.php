...
$query = "insert into user_register values('','$fname','$lname','$user','$email','$pass','$gender','$role_type')";

$result = mysqli_query($conn,$query); //execute query

if($result)
{
  header("Location:login.php");  //navigate to next page
}
else
{
  echo 'error';
...
<div class="radio">
  <label><input type="radio" name="gender" value="male"> Male</label>
            ...
            <select name="role_type" class="form-control" aria-label="Default select example">
 <?php
